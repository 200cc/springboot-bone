...
public class CaptchaUtil {
    ...
    static {
        try (InputStream in = CaptchaUtil.class.getClassLoader().getResourceAsStream("arial.ttf")) {
     ...
     *            验证码字符数
     */
    public CaptchaUtil(int width, int height, int margin, int padding, int size) {
        this.width = width;
        this.height = height;
        this.margin = margin;
